...
def main():
    ...
    # or by passing the --help flag to this script.sh.
    ...
    if training_args.margin_loss:
        pretrained_module = BartForCausalLM.from_pretrained(
            '',
            add_cross_attention=False)  ## nn.module类
    ...
    test_dataset = datasets["train"] if training_args.do_predict is not None and "test" in datasets else datasets[
        "validation"]
